...
Les articles du blog sont définis dans `core/views.py`, donc aucune base de données n'est nécessaire pour afficher le blog sur Vercel. Les images du blog doivent être placées dans `static/images/`.
